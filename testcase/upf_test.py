...
class UpfTestCase(unittest.TestCase):
    """测试用例说明"""
    ...
    def test_basic_log(self):
        """测试 UPF LOG """
        self.common_func("UPF", "LOG", "")

    @unittest.skipUnless(ALL or ("SBI" in TAB), "条件为真执行测试")
    def test_basic_sbi(self):
        """测试 UPF SBI """
        self.common_func("UPF", "SBI", "")

    # @unittest.skipUnless(ALL or ("PM" in TAB), "条件为真执行测试")
    # def test_basic_pm(self):
    #     """测试 UPF PM """
    #     self.common_func("UPF", "PM", "")  # web顺序是乱的，第一个取第二个，第二个取第一个  todo

    @unittest.skipUnless(ALL or ("Service" in TAB and "Service" in LAB), "条件为真执行测试")
    def test_basic_service(self):
        """测试 UPF Service->Service """
        self.common_func("UPF", "Service", "Service")

    @unittest.skipUnless(ALL or ("Data Network" in TAB), "条件为真执行测试")
    def test_basic_data_network(self):
        """测试 UPF Data Network """
        self.curl_func("UPF", "Data Network", "")

    @unittest.skipUnless(ALL or ("Timer" in TAB), "条件为真执行测试")
    def test_basic_timer(self):
        """测试 UPF Data Timer """
        self.common_func("UPF", "Timer", "")

    # @unittest.skipUnless(ALL or ("Interface" in TAB), "条件为真执行测试")
    # def test_basic_interface_n3_n6(self):
    #     """测试 UPF Data Interface N3-N6"""
    #     self.common_func("UPF", "Interface", "N3-N6")

    # @unittest.skipUnless(ALL or ("Gateway" in TAB), "条件为真执行测试")
    # def test_basic_interface_gateway(self):
    #     """测试 UPF Data Interface Gateway"""
    #     self.common_func("UPF", "Interface", "Gateway")

    # @unittest.skipUnless(ALL or ("Mask" in TAB), "条件为真执行测试")
    # def test_basic_interface_mask(self):
    #     """测试 UPF Data Interface Mask"""
    #     self.common_func("UPF", "Interface", "Mask")
    #
    # @unittest.skipUnless(ALL or ("N4" in TAB), "条件为真执行测试")
    # def test_basic_interface_n4(self):
    #     """测试 UPF Data Interface N4"""
    #     self.common_func("UPF", "Interface", "N4")
